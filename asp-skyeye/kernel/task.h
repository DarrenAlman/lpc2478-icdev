 ...
 *  の責任を負わない．
 * 
 *  @(#) $Id: task.h 1454 2009-02-18 10:20:50Z ertl-hiro $
 */
 ...
 *  と起動要求キューイング数の最大値（TMAX_WUPCNT）は1に固定されている
 ...
 *  タスクディスパッチ可能状態
 *
 *  ディスパッチ禁止状態でなく，割込み優先度マスク（IPM）がTIPM_ENAALL
 *  であることを示すフラグ．
 */
 ...
 *  実行できる状態に移行したタスクへのディスパッチが必要な場合はtrue，
 *  そうでない場合はfalseを返す．
 */
