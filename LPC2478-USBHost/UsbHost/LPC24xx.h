/******************************************************************************
 *   LPC24xx.h:  Header file for NXP LPC24xx Family Microprocessors
 *   The header file is the super set of all hardware definition of the 
 *   peripherals for the LPC24xx family microprocessor.
 *
 *   Copyright(C) 2006-2009, NXP Semiconductor
 *   All rights reserved.
 *
 *   History
 *   2009.03.03  ver 1.00    Prelimnary version, first Release
 *   2009.03.13  ver 1.01    FIO1MASK1,FIO1SET1,FIO1CLR1 value corrected
 *
******************************************************************************/
...
#define USBPortSel 			OTG_STAT_CTRL
#define USBClkCtrl          OTG_CLK_CTRL
#define USBClkSt            OTG_CLK_STAT
